...
- Pitfalls found here should translate into concrete craft fixes (e.g. "drop the 3D effect and start the axis at zero"), not a re-diagnosis of type or depth — that's a separate axis, covered in `Analytics_Design_Framework.md`.
